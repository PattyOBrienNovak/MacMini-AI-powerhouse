...
**Not a good time right now?** That's completely fine. Put this down and come back when you have a clear window. This playbook will be here. Your Mac Mini will be here. You get to choose when you're ready.

**What to have nearby before you start:**
- [ ] Apple ID email and password
- [ ] WiFi network name and password
- [ ] Monitor with available HDMI or USB-C port
...
Before connecting anything, get organized:

- Clear desk space around the Mac Mini
- Make sure your monitor is within cable reach
- Have your keyboard and mouse/trackpad accessible

**No rushing. No "I'll just quickly..." — get set up properly first.**

---

## Step 2: Connect Everything (In This Order)

Order matters. Follow this sequence:

**1. Monitor first**
Plug your monitor cable into the back of the Mac Mini.
- Got an HDMI cable? Use the HDMI port
...
> **Why power last?** Connecting power starts the boot process. You want everything else ready before that happens.
...
**Accessibility**
→ Options for vision, hearing, motor, and cognitive accessibility features.
...
>
> *Full disclosure: the author of this playbook turned it off for exactly this reason. Remembering passwords and keeping them straight is a real, ongoing challenge — and the risk of being permanently locked out of an Apple account wasn't worth it. You're in good company.*
>
...
> **Remember:** You don't have to do Playbook 2 today. Each playbook is its own complete win. Come back when you have another focused window.
